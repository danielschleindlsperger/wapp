...
<?php
  ...
  echo '<h3>Company</h3>';
  echo $this->Form->input('client_name', ['type' => 'text', 'required' => 'required']);
  echo '<h3>Adress</h3>';
  echo $this->Form->input('street', ['type' => 'text', 'required' => 'required']);
  echo $this->Form->input('street_number', ['type' => 'text', 'required' => 'required']) ;
  echo $this->Form->input('area_code', ['type' => 'text', 'required' => 'required']) ;
  echo $this->Form->input('city', ['type' => 'text', 'required' => 'required']) ;
  echo $this->Form->input('country', ['type' => 'text', 'required' => 'required']) ;
